...
const ContactUserDetails = () => {
	...
	const [nomineeContactNumber, setNomineeContactNumber] = useState('7076401049');
	...
	const handleSave = () => {
		...
		console.log('Alternate Email ID:', alternateEmail);
		console.log('Contact Number:', contactNumber);
		console.log('Nominee Name:', nomineeName);
		console.log('Nominee Contact Number:', nomineeContactNumber);
		console.log('Nominee Email ID:', nomineeEmail);
	};
